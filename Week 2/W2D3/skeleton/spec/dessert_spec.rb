...
describe Dessert do
  let(:chef) { double("chef", name: "Wilson") }
  ...
  describe "#serve" do
    it "contains the titleized version of the chef's name" do
      allow(chef).to receive(:titleize).and_return("Chef Wilson the Great Baker")
      expect(dessert.serve).to eq("Chef Wilson the Great Baker has made 10 cakes!")
    end
  end
